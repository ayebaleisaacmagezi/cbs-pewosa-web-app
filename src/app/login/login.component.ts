...
export class LoginComponent implements OnInit {
  ...
  logoPath = 'assets/images/kcps-logo.png';
  logoPathDark = 'assets/images/kcps-logo.png';
  ...
  updateLogo(): void {
    ...
    if (environment.tenantLogoUrl && environment.tenantLogoUrl.trim() !== '') {
      ...
      this.logoPath = isTenantSpecific ? `assets/images/${tenant}_home.png` : 'assets/images/kcps-logo.png';
    }
    ...
    if (environment.tenantLogoUrlDark && environment.tenantLogoUrlDark.trim() !== '') {
      ...
      this.logoPathDark = isTenantSpecific ? `assets/images/${tenant}_home_dark.png` : 'assets/images/kcps-logo.png';
    }
  }

  onLogoError(): void {
    this.logoPath = 'assets/images/kcps-logo.png';
  }

  onLogoErrorDark(): void {
    this.logoPathDark = 'assets/images/kcps-logo.png';
  }
}
