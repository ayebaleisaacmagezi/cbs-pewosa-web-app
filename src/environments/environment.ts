...
export const environment = {
  ...
  baseApiUrls: loadedEnv.fineractApiUrls || 'https://portal.cbspewosa.com',
  // For connecting to server running elsewhere set the base API URL
  baseApiUrl:
    loadedEnv.fineractApiUrl ||
    (loadedEnv.fineractApiUrls?.length > 0 ? loadedEnv.fineractApiUrls.split(',')[0] : 'https://portal.cbspewosa.com'),
  ...
  /**
   * Postal Code Lookup â€” auto-fill city/state/country from postal code.
